...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {A_UP}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {A_DOWN}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {A_LEFT}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {A_RIGHT}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {A_TR}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {A_TL}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {A_RESET}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {A_TH}];  # "JA9"
