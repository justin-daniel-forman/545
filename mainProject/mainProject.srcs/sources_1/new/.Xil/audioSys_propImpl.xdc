set_property SRC_FILE_INFO {cfile:/afs/ece.cmu.edu/usr/suyashb/Private/545/mainProject/mainProject.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xdc rfile:../../ip/clk_wiz_0/clk_wiz_0.xdc id:1 order:EARLY scoped_inst:interfaceTest/serialClocks/inst} [current_design]
set_property SRC_FILE_INFO {cfile:/afs/ece.cmu.edu/usr/suyashb/Private/545/mainProject/zedboard_master_XDC_RevC_D_v3.xdc rfile:../../../../zedboard_master_XDC_RevC_D_v3.xdc id:2} [current_design]
set_property src_info {type:SCOPED_XDC file:1 line:56 export:INPUT save:INPUT read:READ} [current_design]
set_input_jitter [get_clocks -of_objects [get_ports clk_main]] 0.1
